...
.data
    message_arguments_error     db "Wrong arguments. You need write: laba5 file_name.txt$"
    message_file_missing        db "Can't open file. Probably it's missing$"
    message_success             db "Count of string with your word $"
    
    message_input_word          db "This program counts strings with your word. Enter the word:$"
